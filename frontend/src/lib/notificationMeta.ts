...
const META: Record<string, NotificationMeta> = {
  PROJECT_INVITE: { icon: UserPlus, colorClass: "text-accent bg-accent/10", label: "Invitation" },
  PROJECT_INVITE_ACCEPTED: { icon: UserCheck, colorClass: "text-emerald-500 bg-accent/10", label: "Invitation accepted" },
  PROJECT_INVITE_DECLINED: { icon: UserX, colorClass: "text-primary bg-primary/10", label: "Invitation declined" },
  JOIN_REQUEST_APPROVED: { icon: CheckCheck, colorClass: "text-emerald-500 bg-accent/10", label: "Request approved" },
  ...
  PROJECT_JOINED: { icon: Users, colorClass: "text-emerald-500 bg-accent/10", label: "New member" },
  ...
  MEMBER_ROLE_CHANGED: { icon: Shield, colorClass: "text-primary bg-primary/10", label: "Role changed" },
  OWNERSHIP_TRANSFERRED: { icon: UserCog, colorClass: "text-primary bg-primary/10", label: "Ownership transferred" },
  PROJECT_VISIBILITY_CHANGED: { icon: FolderKanban, colorClass: "text-emerald-500 bg-accent/10", label: "Project visibility" },
  PROJECT_UPDATE: { icon: FolderKanban, colorClass: "text-emerald-500 bg-accent/10", label: "Project update" },
  TASK_ASSIGNED: { icon: CheckCheck, colorClass: "text-primary bg-primary/10", label: "Task assigned" },
  ...
  TASK_STARTED: { icon: PlayCircle, colorClass: "text-primary bg-primary/10", label: "Task started" },
  BRANCH_CREATED: { icon: GitBranch, colorClass: "text-emerald-500 bg-accent/10", label: "Branch created" },
  PR_OPENED: { icon: GitPullRequest, colorClass: "text-blue-500 bg-blue-500/10", label: "Pull request opened" },
  PR_APPROVED: { icon: CheckCircle2, colorClass: "text-emerald-500 bg-accent/10", label: "Pull request approved" },
  PR_CHANGES_REQUESTED: { icon: MessageSquarePlus, colorClass: "text-primary bg-primary/10", label: "Changes requested" },
  PR_MERGED: { icon: GitMerge, colorClass: "text-accent bg-accent/10", label: "Pull request merged" },
  ...
  REPORT: { icon: FileWarning, colorClass: "text-accent bg-accent/10", label: "Report" },
  // Billing (Razorpay) notifications — see BillingService/PlanService.
  PAYMENT_SUCCESS: { icon: CreditCard, colorClass: "text-emerald-500 bg-accent/10", label: "Payment" },
  PAYMENT_FAILED: { icon: CreditCard, colorClass: "text-red-500 bg-red-500/10", label: "Payment failed" },
  PAYMENT_REFUNDED: { icon: CreditCard, colorClass: "text-primary bg-primary/10", label: "Refund" },
  SUBSCRIPTION_PAST_DUE: { icon: AlertCircle, colorClass: "text-primary bg-primary/10", label: "Action needed" },
  SUBSCRIPTION_CANCELLED: { icon: CreditCard, colorClass: "text-accent bg-accent/10", label: "Subscription" },
  ...
  SUPPORT_STATUS_CHANGED: { icon: Bell, colorClass: "text-primary bg-primary/10", label: "Support update" },
};
