        ...
        <div className="relative rounded-3xl p-px bg-gradient-to-br from-primary/40 via-accent/30 to-pink-500/40 shadow-2xl shadow-primary/10 overflow-hidden">
          ...
          <div className="relative rounded-3xl bg-card/80 backdrop-blur-2xl px-6 py-14 md:py-20 text-center">
            ...
            <p className="mt-6 text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
              Join the platform that helps developers ship better software,
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                ...
                className="w-full sm:w-auto text-base px-10 h-12 shadow-xl hover:shadow-2xl transition-all duration-200 bg-primary text-primary-foreground hover:from-primary hover:to-primary relative overflow-hidden group hover:scale-[1.02] active:scale-[0.98]"
              >
